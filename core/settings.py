...
tmpPostgres = urlparse(
    "postgresql://neondb_owner:npg_taP9z8yTgWfM@ep-weathered-bread-acp9rhi2-pooler.sa-east-1.aws.neon.tech/neondb?sslmode=require"
)

DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.sqlite3",
        "NAME": BASE_DIR / "db.runners",
    }
}
...
# Add custom user model configuration for Django Allauth
...
# ACCOUNT_CONFIRMATION_EXPIRE_DAYS = 1
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "OpenAPI 3 schema auto-generated by drf-spectacular",
    "VERSION": "1.0.0",
    # Use Bearer auth for secured endpoints
    "SECURITY": [{"bearerAuth": []}],
